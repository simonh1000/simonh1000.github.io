...
Elm.GoogleMap.make = function (_elm) {
   "use strict";
   _elm.GoogleMap = _elm.GoogleMap || {};
   if (_elm.GoogleMap.values)
   return _elm.GoogleMap.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Main.make = function (_elm) {
   ...
   app.tasks);
   var lat = Elm.Native.Port.make(_elm).outboundSignal("lat",
   function (v) {
      return v;
   },
   A2($Signal.map,
...
Elm.Map = Elm.Map || {};
Elm.Map.make = function (_elm) {
   "use strict";
   _elm.Map = _elm.Map || {};
   if (_elm.Map.values)
   return _elm.Map.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Basics = Elm.Basics.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $GoogleMap = Elm.GoogleMap.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   model) {
      ...
      address,
      North)]),
      _L.fromArray([$Html.text("North")]))]));
   });
   var init = {_: {}
              ,lat: 43
              ,lng: 4.5};
   _elm.Map.values = {_op: _op
                     ,init: init
                     ,update: update
                     ,view: view};
   return _elm.Map.values;
